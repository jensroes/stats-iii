...
## Recap: Normal linear model {.smaller}
...
- Distribution can be characterised by an unknown mean $\mu_i$ and variance $\sigma^2$.
...
## Recap: Maximum likelihood estimates {.smaller}
...
- Likelihood of the data under a model
- Explained and unexplained variance in the data
- Fit to data
