...
- Interpret model coefficients represent and quantities of null hypothesis testing such as confidence interval, *t*-value, *p*-value
- Conceptual understand what maximum likelihood estimation
...
>- Extract the `linear-models` folder
