...
beta_0 <- coefs[---] # the right index (either 1 or 2)
beta_1 <- coefs[---] # the right index (either 1 or 2)
...
# How can you calculate mu_hat given the variables you have already got?
mu_hat <- --- + --- * ---
