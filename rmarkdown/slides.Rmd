...
tinytex::install_tinytex() # and restart RStudio
```
...
>- Create a new *R chunk*: try `CTRL+ALT+I` or `CMD+ALT+I` (upper case "i")
...
- How about $\sigma_e^2$
- For a list of $\LaTeX$ symbols **see page 19 in lecture notes**.
